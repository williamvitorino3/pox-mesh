...
that API when this gets input from the GUI (for example, think monitoring).
...
"""
Esta é a interface de comunicação entre o POX ea GUI.
O componente de back-end gui atua como um proxy entre outros componentes ea GUI.

GUI --> Componente do POX:
Se quisermos ativar a funcionalidade do componente através da GUI, o componente
deve expor essa funcionalidade por meio de sua API. O "backend" deve apenas chamar
essa API quando isso recebe entrada da GUI (por exemplo, pense em monitoramento).

Componente do POX --> GUI:
Se o componente quer enviar algo para a GUI, ele só levanta eventos.
O backend escuta esses eventos e os mapeia e os envia para a GUI.

Nota: as mensagens de log são tratadas separadamente e usam seu próprio canal de comunicação.
"""
...
class GuiMessengerService (EventMixin):
    ...
    def __init__(self, connection, params):
        """
        Contrutor da classe GuiMessengerService.
        :param connection: Conexão a ser tratada.
        :param params: Paramentros da conexão.
        """
    ...
    def _handle_topology_SwitchJoin(self, event):
        """
        Cria um dicionário com detalhes da topologia da conexão do lado do Switch e o envia.
        :param event: Evento que lança a chamada da função.
        :return: Sem retorno.
        """
        msg = {}
        msg["type"] = "topology"
    ...
    def _handle_topology_HostJoin(self, event):
        """
        Cria um dicionário com detalhes da topologia da conexão do lado do Host e o envia.
        :param event: Evento que lança a chamada da função.
        :return: Sem retorno.
        """
        msg = {}
    ...
    def _handle_openflow_discovery_LinkEvent(self, event):
        """
        Cria um dicionário com detalhes do link openflow e o envia.
        :param event: Evento que lança a chamada da função.
        :return: Sem retorno.
        """
        msg = {}
    ...
    def _handle_MessageReceived(self, event, msg):
        """
        Gerencia a mensagem recebida e executa a ação necessária.
        :param event: Evento de lançamento do método.
...
class GuiMessengerServiceListener (object):
    def __init__(self):
        """
        Contrutor da classe GuiMessengerServiceListener.
        """
    ...
    def _handle_global_MessageReceived(self, event, msg):
        """
        Gerencia todas as mensagens recebidas.
        :param event: Evento de lançamento do método.
        :param msg: Mensagem recebida.
        :return: Sem retorno.
        """
...
def launch():
    """
    Lançador do componente Messenger.
    :return: Sem retorno.
    """
